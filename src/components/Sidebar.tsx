  ...
  return (
    <>
      ...
      {sidebarTransition((style, item) => {
        return (
          item && (
            <animated.aside style={style} className="fixed bottom-0 right-0 top-0 z-20 w-3/4 divide-y-2 divide-gray-300 bg-primary px-6 py-4 md:hidden" onClick={() => setIsOpen(false)}>
