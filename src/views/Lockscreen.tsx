...
function Lockscreen(): React.JSX.Element {
  ...
  const src = useImage("../../img/pagi.webp");
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      <div className="relative h-full w-full bg-hp bg-cover bg-center before:absolute before:left-0 before:top-0 before:h-full before:w-full before:bg-black/[0.45] before:content-[''] md:-scale-x-100 md:bg-desktop md:bg-right"></div>;
      {isImageReady && quotes && (
